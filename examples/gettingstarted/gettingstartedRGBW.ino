...
#define COLOR_ORDER_GRBW  //give access to
#define USE_FASTLED //to enable the Mapping  CRGB<=>Pixel
...
and there is an automatic convertion from CRGB to RGBW
hence Pixel color=CRGB(r,g,b) will work
formula used:
         white = MIN(red, green);
